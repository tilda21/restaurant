...
exports.isInstrumentationHookFilename = isInstrumentationHookFilename;
...
exports.isInstrumentationHookFile = isInstrumentationHookFile;
exports.getPossibleInstrumentationHookFilenames = getPossibleInstrumentationHookFilenames;
exports.getPossibleMiddlewareFilenames = getPossibleMiddlewareFilenames;
exports.getSupportedBrowsers = getSupportedBrowsers;
exports.collectGenerateParams = exports.collectAppConfig = void 0;
...
var _requireHook = require("./webpack/require-hook");
var _isClientReference = require("./is-client-reference");
...
var _additionalSsgPathsByPath, _pathsPage;
...
async function computeFromManifest(manifests, distPath, gzipSize = true, pageInfos) {
    ...
    await Promise.all([
        ...new Set([
            ...
            ...((ref1 = files.app) == null ? void 0 : ref1.each.keys()) ?? [], 
        ]), 
    ].map(async (f)=>{
        try {
...
async function printTreeView(lists, pageInfos, { distPath , buildId , pagesDir , pageExtensions , buildManifest , appBuildManifest , middlewareManifest , useStatic404 , gzipSize =true  }) {
    ...
    const printFileTree = async ({ list , routerType  })=>{
        ...
        filterAndSortList(list).forEach((item, i, arr)=>{
            ...
            const totalDuration = ((pageInfo == null ? void 0 : pageInfo.pageDuration) || 0) + ((pageInfo == null ? void 0 : (ref7 = pageInfo.ssgPageDurations) == null ? void 0 : ref7.reduce((a, b)=>a + (b || 0), 0)) || 0);
            ...
            const uniqueCssFiles = ((ref3 = buildManifest.pages[item]) == null ? void 0 : ref3.filter((file)=>{
                var ref;
            ...
            if (pageInfo == null ? void 0 : (ref4 = pageInfo.ssgPageRoutes) == null ? void 0 : ref4.length) {
        ...
        const sharedFilesSize = (ref6 = stats.router[routerType]) == null ? void 0 : ref6.common.size.total;
        const sharedFiles = ((ref2 = stats.router[routerType]) == null ? void 0 : ref2.common.files) ?? [];
        messages.push([
    ...
    const middlewareInfo = (ref5 = middlewareManifest.middleware) == null ? void 0 : ref5["/"];
...
exports.collectAppConfig = collectAppConfig;
const collectGenerateParams = async (segment, parentSegments = [], generateParams = [])=>{
    var ref, ref8, ref9, ref10, ref11, ref12, ref13, ref14;
    if (!Array.isArray(segment)) return generateParams;
    const isLayout = !!((ref = segment[2]) == null ? void 0 : ref.layout);
    const mod = await (isLayout ? (ref8 = segment[2]) == null ? void 0 : (ref9 = ref8.layout) == null ? void 0 : (ref10 = ref9[0]) == null ? void 0 : ref10.call(ref9) : (ref11 = segment[2]) == null ? void 0 : (ref12 = ref11.page) == null ? void 0 : (ref13 = ref12[0]) == null ? void 0 : ref13.call(ref12));
    const config = collectAppConfig(mod);
    const isClientComponent = (0, _isClientReference).isClientReference(mod);
    const result = {
        isLayout,
    ...
    return collectGenerateParams((ref14 = segment[1]) == null ? void 0 : ref14.children, parentSegments, generateParams);
};
...
async function isPageStatic({ page , distDir , configFileName , runtimeEnvConfig , httpAgentOptions , enableUndici , locales , defaultLocale , parentId , pageRuntime , edgeInfo , pageType , hasServerComponents , originalAppPath  }) {
    ...
    return isPageStaticSpan.traceAsyncFn(async ()=>{
        ...
        if ((0, _isEdgeRuntime).isEdgeRuntime(pageRuntime)) {
            ...
            isClientComponent = (0, _isClientReference).isClientReference(mod);
            componentsResult = {
        ...
        if (pageType === "app") {
            isClientComponent = (0, _isClientReference).isClientReference(componentsResult.ComponentMod);
...
function detectConflictingPaths(combinedPages, ssgPages, additionalSsgPaths) {
    ...
    additionalSsgPaths.forEach((paths, pathsPage)=>{
        (_additionalSsgPathsByPath = additionalSsgPathsByPath)[_pathsPage = pathsPage] || (_additionalSsgPathsByPath[_pathsPage] = {});
...
async function copyTracedFiles(dir, distDir, pageKeys, appPageKeys, tracingRoot, serverConfig, middlewareManifest) {
    ...
    for (const page of Object.values(middlewareManifest.functions)){
        ...
        for (const file1 of [
            ...
            const originalPath = _path.default.join(distDir, file1.filePath);
            const fileOutputPath = _path.default.join(outputPath, _path.default.relative(tracingRoot, distDir), file1.filePath);
            await _fs.promises.mkdir(_path.default.dirname(fileOutputPath), {
                recursive: true
            });
            await _fs.promises.copyFile(originalPath, fileOutputPath);
    ...
    for (const page1 of pageKeys){
        if (middlewareManifest.functions.hasOwnProperty(page1)) {
            continue;
        }
        const pageFile = _path.default.join(distDir, "server", "pages", `${(0, _normalizePagePath).normalizePagePath(page1)}.js`);
    ...
    await _fs.promises.writeFile(serverOutputPath, `${moduleType ? `import Server from 'next/dist/server/next-server.js'
...
function getPossibleInstrumentationHookFilenames(folder, extensions) {
    return extensions.map((extension)=>_path.default.join(folder, `${_constants.INSTRUMENTATION_HOOK_FILENAME}.${extension}`));
}
