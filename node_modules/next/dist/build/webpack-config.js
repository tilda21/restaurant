...
var _nextTypesPlugin = require("./webpack/plugins/next-types-plugin");
...
var _discover = require("./webpack/loaders/metadata/discover");
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =_constants1.COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false , jsConfig , resolvedBaseUrl , supportedBrowsers , clientRouterFilters  }) {
    var ref41, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, // allows add JsConfigPathsPlugin to allow hot-reloading
    // if the config is added/removed
    ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref20, ref21;
    ...
    if (isClient) {
        if ((0, _isEdgeRuntime).isEdgeRuntime(config.experimental.runtime)) {
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref22 = require("./swc")) == null ? void 0 : ref22.getBinaryMetadata == null ? void 0 : (ref23 = ref22.getBinaryMetadata()) == null ? void 0 : ref23.target;
    ...
    const getSwcLoader = (extraOptions)=>{
        ...
        if ((config == null ? void 0 : (ref = config.experimental) == null ? void 0 : ref.swcTraceProfiling) && !swcTraceProfilingInitialized) {
            ...
            (ref40 = require("./swc")) == null ? void 0 : ref40.initCustomTraceSubscriber == null ? void 0 : ref40.initCustomTraceSubscriber(_path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return {
    ...
    const reactDir = _path.default.dirname(require.resolve("react/package.json"));
    const reactDomDir = _path.default.dirname(require.resolve("react-dom/package.json"));
    ...
    const looseEsmExternals = ((ref41 = config.experimental) == null ? void 0 : ref41.esmExternals) === "loose";
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        const isLocalCallback = (localRes)=>{
            ...
            if (layer === _constants.WEBPACK_LAYERS.server) return;
    ...
    let webpackConfig = {
                ...
                ...!config.images.disableStaticImages ? [
                    {
                        ...
                        resourceQuery: (queryString)=>queryString !== _discover.METADATA_IMAGE_RESOURCE_QUERY,
                        options: {
                            isServer: isNodeServer || isEdgeServer,
                            isDev: dev,
        ...
        plugins: [
            ...
            isClient && new _fontLoaderManifestPlugin.FontLoaderManifestPlugin({
    ...
    if (resolvedBaseUrl) {
        var ref24, ref25;
        (ref24 = webpackConfig.resolve) == null ? void 0 : (ref25 = ref24.modules) == null ? void 0 : ref25.push(resolvedBaseUrl);
    }
    ...
    if (isEdgeServer) {
        var ref26, ref27, ref28, ref29, ref30, ref31;
        (ref26 = webpack5Config.module) == null ? void 0 : (ref27 = ref26.rules) == null ? void 0 : ref27.unshift({
            test: /\.wasm$/,
            loader: "next-middleware-wasm-loader",
            type: "javascript/auto",
            resourceQuery: /module/i
        });
        (ref28 = webpack5Config.module) == null ? void 0 : (ref29 = ref28.rules) == null ? void 0 : ref29.unshift({
            dependency: "url",
            loader: "next-middleware-asset-loader",
            type: "javascript/auto",
            layer: _constants.WEBPACK_LAYERS.edgeAsset
        });
        (ref30 = webpack5Config.module) == null ? void 0 : (ref31 = ref30.rules) == null ? void 0 : ref31.unshift({
    ...
    const configVars = JSON.stringify({
        ...
        legacyBrowsers: (ref18 = config.experimental) == null ? void 0 : ref18.legacyBrowsers,
    ...
    if (typeof config.webpack === "function") {
        ...
        if (((ref32 = webpack5Config.experiments) == null ? void 0 : ref32.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref33 = webpack5Config.experiments) == null ? void 0 : ref33.lazyCompilation) === "object" && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref34;
        const rules = ((ref34 = webpackConfig.module) == null ? void 0 : ref34.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref19 = webpackConfig.module) == null ? void 0 : ref19.rules) && webpackConfig.plugins) {
    ...
    const hasUserCssConfig = ((ref20 = webpackConfig.module) == null ? void 0 : (ref21 = ref20.rules) == null ? void 0 : ref21.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) ?? false;
    if (hasUserCssConfig) {
        var ref35, ref36, ref37, ref38, ref39;
        ...
        if ((ref35 = webpackConfig.module) == null ? void 0 : (ref36 = ref35.rules) == null ? void 0 : ref36.length) {
        ...
        if ((ref37 = webpackConfig.plugins) == null ? void 0 : ref37.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true);
        }
        if ((ref38 = webpackConfig.optimization) == null ? void 0 : (ref39 = ref38.minimizer) == null ? void 0 : ref39.length) {
...
function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , isNodeServer , isEdgeServer , middlewareMatchers , clientRouterFilters  }) {
    var ref, ref42, ref43;
    return {
        ...
        "process.env.__NEXT_IMAGE_OPTS": JSON.stringify({
            ...
            ...dev ? {
                ...
                remotePatterns: (ref42 = config.images) == null ? void 0 : ref42.remotePatterns
            } : {}
        }),
        "process.env.__NEXT_ROUTER_BASEPATH": JSON.stringify(config.basePath),
        "process.env.__NEXT_HAS_REWRITES": JSON.stringify(hasRewrites),
        "process.env.__NEXT_I18N_SUPPORT": JSON.stringify(!!config.i18n),
        "process.env.__NEXT_I18N_DOMAINS": JSON.stringify((ref43 = config.i18n) == null ? void 0 : ref43.domains),
...
function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (ref = webpackConfig.module) == null ? void 0 : (ref44 = ref.rules) == null ? void 0 : ref44.forEach((rule)=>{
