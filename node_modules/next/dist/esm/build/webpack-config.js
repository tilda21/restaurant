...
import { DOT_NEXT_ALIAS, PAGES_DIR_ALIAS, ROOT_DIR_ALIAS, APP_DIR_ALIAS, WEBPACK_LAYERS, RSC_MOD_REF_PROXY_ALIAS } from "../lib/constants";
...
import MiddlewarePlugin, { handleWebpackExternalForEdgeRuntime } from "./webpack/plugins/middleware-plugin";
...
export function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , isNodeServer , isEdgeServer , middlewareMatchers , clientRouterFilters  }) {
    var ref, ref1, ref2;
    return {
        ...
        "process.env.__NEXT_IMAGE_OPTS": JSON.stringify({
            ...
            ...dev ? {
                ...
                remotePatterns: (ref1 = config.images) == null ? void 0 : ref1.remotePatterns
            } : {}
        }),
        "process.env.__NEXT_ROUTER_BASEPATH": JSON.stringify(config.basePath),
        "process.env.__NEXT_HAS_REWRITES": JSON.stringify(hasRewrites),
        "process.env.__NEXT_I18N_SUPPORT": JSON.stringify(!!config.i18n),
        "process.env.__NEXT_I18N_DOMAINS": JSON.stringify((ref2 = config.i18n) == null ? void 0 : ref2.domains),
...
export function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (ref = webpackConfig.module) == null ? void 0 : (ref3 = ref.rules) == null ? void 0 : ref3.forEach((rule)=>{
...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false , jsConfig , resolvedBaseUrl , supportedBrowsers , clientRouterFilters  }) {
    var ref44, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, // allows add JsConfigPathsPlugin to allow hot-reloading
    ...
    if (isClient) {
        ...
        if (config.experimental.typedRoutes && !hasAppDir) {
            Log.warn("`experimental.typedRoutes` requires `experimental.appDir` to be enabled.");
        }
    }
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref25 = require("./swc")) == null ? void 0 : ref25.getBinaryMetadata == null ? void 0 : (ref26 = ref25.getBinaryMetadata()) == null ? void 0 : ref26.target;
    ...
    const getSwcLoader = (extraOptions)=>{
        ...
        if ((config == null ? void 0 : (ref = config.experimental) == null ? void 0 : ref.swcTraceProfiling) && !swcTraceProfilingInitialized) {
            ...
            (ref43 = require("./swc")) == null ? void 0 : ref43.initCustomTraceSubscriber == null ? void 0 : ref43.initCustomTraceSubscriber(path.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return {
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...isEdgeServer ? {
                ...
                "@opentelemetry/api": hasOptionalOTELAPIPackage ? "@opentelemetry/api" : "next/dist/compiled/@opentelemetry/api"
            } : undefined,
            ...
            [RSC_MOD_REF_PROXY_ALIAS]: "next/dist/build/webpack/loaders/next-flight-loader/module-proxy",
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        if (layer === WEBPACK_LAYERS.server) {
            if (reactPackagesRegex.test(request) || request === "next/dist/compiled/react-server-dom-webpack/server.edge") {
                return;
            }
        }
        ...
        if (!isLocal) {
            ...
            if (/^(react(?:$|\/)|react-dom(?:$|\/))/.test(request)) {
                ...
                if (request === "react-dom" && (layer === WEBPACK_LAYERS.client || layer === WEBPACK_LAYERS.server)) {
        ...
        const shouldBeBundled = isResourceInPackages(res, config.transpilePackages, resolvedExternalPackageDirs) || isEsm && config.experimental.appDir;
    ...
    let webpackConfig = {
                        ...
                        oneOf: [
                            ...
                            },
                            {
                                ...
                                resolve: {
                                    alias: {
                                        react: "next/dist/compiled/react",
                                        "react-dom$": reactProductionProfiling ? "next/dist/compiled/react-dom/cjs/react-dom.profiling.min" : "next/dist/compiled/react-dom",
                                        "react-dom/client$": "next/dist/compiled/react-dom/client"
                                    }
                                }
                            }, 
                ...
                ...!config.images.disableStaticImages ? [
                    {
                        ...
                        resourceQuery: (queryString)=>queryString !== METADATA_IMAGE_RESOURCE_QUERY,
                        options: {
                            isServer: isNodeServer || isEdgeServer,
                            isDev: dev,
        ...
        plugins: [
            ...
            isEdgeServer && new MiddlewarePlugin({
                dev,
                sriEnabled: !dev && !!((ref4 = config.experimental.sri) == null ? void 0 : ref4.algorithm)
            }),
            ...
            hasServerComponents && (isClient ? new FlightManifestPlugin({
                dev,
                appDir
            ...
            !dev && isClient && !!((ref5 = config.experimental.sri) == null ? void 0 : ref5.algorithm) && new SubresourceIntegrityPlugin(config.experimental.sri.algorithm),
            isClient && new FontLoaderManifestPlugin({
            ...
            !dev && isClient && new (require("./webpack/plugins/telemetry-plugin")).TelemetryPlugin(new Map([
                ...
                [
                    "swcRelay",
                    !!((ref6 = config.compiler) == null ? void 0 : ref6.relay)
                ],
                [
                    "swcStyledComponents",
                    !!((ref7 = config.compiler) == null ? void 0 : ref7.styledComponents)
                ],
                [
                    "swcReactRemoveProperties",
                    !!((ref8 = config.compiler) == null ? void 0 : ref8.reactRemoveProperties), 
                ],
                [
                    "swcExperimentalDecorators",
                    !!(jsConfig == null ? void 0 : (ref9 = jsConfig.compilerOptions) == null ? void 0 : ref9.experimentalDecorators), 
                ],
                [
                    "swcRemoveConsole",
                    !!((ref10 = config.compiler) == null ? void 0 : ref10.removeConsole)
                ],
                [
                    "swcImportSource",
                    !!(jsConfig == null ? void 0 : (ref11 = jsConfig.compilerOptions) == null ? void 0 : ref11.jsxImportSource)
                ],
                [
                    "swcEmotion",
                    !!((ref12 = config.compiler) == null ? void 0 : ref12.emotion)
                ],
                [
                    "turbotrace",
    ...
    if (resolvedBaseUrl) {
        var ref27, ref28;
        (ref27 = webpackConfig.resolve) == null ? void 0 : (ref28 = ref27.modules) == null ? void 0 : ref28.push(resolvedBaseUrl);
    }
    (ref13 = webpackConfig.resolve) == null ? void 0 : (ref14 = ref13.plugins) == null ? void 0 : ref14.unshift(new JsConfigPathsPlugin((jsConfig == null ? void 0 : (ref15 = jsConfig.compilerOptions) == null ? void 0 : ref15.paths) || {}, resolvedBaseUrl || dir));
    const webpack5Config = webpackConfig;
    if (isEdgeServer) {
        var ref29, ref30, ref31, ref32, ref33, ref34;
        ...
        (ref33 = webpack5Config.module) == null ? void 0 : (ref34 = ref33.rules) == null ? void 0 : ref34.unshift({
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref16 = config.compiler) == null ? void 0 : ref16.removeConsole,
        reactRemoveProperties: (ref17 = config.compiler) == null ? void 0 : ref17.reactRemoveProperties,
        styledComponents: (ref18 = config.compiler) == null ? void 0 : ref18.styledComponents,
        relay: (ref19 = config.compiler) == null ? void 0 : ref19.relay,
        emotion: (ref20 = config.compiler) == null ? void 0 : ref20.emotion,
        modularizeImports: config.modularizeImports,
        legacyBrowsers: (ref21 = config.experimental) == null ? void 0 : ref21.legacyBrowsers,
    ...
    if (typeof config.webpack === "function") {
        ...
        if (((ref35 = webpack5Config.experiments) == null ? void 0 : ref35.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref36 = webpack5Config.experiments) == null ? void 0 : ref36.lazyCompilation) === "object" && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref37;
        const rules = ((ref37 = webpackConfig.module) == null ? void 0 : ref37.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref22 = webpackConfig.module) == null ? void 0 : ref22.rules) && webpackConfig.plugins) {
    ...
    const hasUserCssConfig = ((ref23 = webpackConfig.module) == null ? void 0 : (ref24 = ref23.rules) == null ? void 0 : ref24.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) ?? false;
    if (hasUserCssConfig) {
        var ref38, ref39, ref40, ref41, ref42;
        ...
        if ((ref38 = webpackConfig.module) == null ? void 0 : (ref39 = ref38.rules) == null ? void 0 : ref39.length) {
        ...
        if ((ref40 = webpackConfig.plugins) == null ? void 0 : ref40.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true);
        }
        if ((ref41 = webpackConfig.optimization) == null ? void 0 : (ref42 = ref41.minimizer) == null ? void 0 : ref42.length) {
